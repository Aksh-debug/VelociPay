...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-2 bg-orange-400 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn("relative flex w-full bg-red-600 min-w-0 flex-col p-2", className)}
      {...props}
    />
  )
})
